...
const userRoles: Role[] = ["editor", "viewer"];

function hasRole(role: Role, roles: Role[]): boolean {
...
// 최신순 (날짜 내림차순)
const byDateDesc = [...posts].sort((a, b) =>
...
// 오래된 순
const byDateAsc = [...posts].sort((a, b) =>
...
// 8. 가격대별 상품 찾기
function findProductsByPriceRange(min: number, max: number): ShopProduct[] {
