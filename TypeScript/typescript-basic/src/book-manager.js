...
function getBooksByStatus(books, status) {
...
function searchBooks(books, keyword) {
    ...
    return books.filter(book => book.title.toLowerCase().includes(lower) ||
...
function printBooks(books, title = "도서 목록") {
    console.log(`\n${"=".repeat(50)}`);
    console.log(`📚 ${title}`);
    console.log("=".repeat(50));
    if (books.length === 0) {
...
console.log("\n\n✅ 도서 관리 시스템 시뮬레이션 완료!");
console.log("=".repeat(50));
//# sourceMappingURL=book-manager.js.map